...
//ArrayList<course>crss=University.getcrs();
University.dummy();
boolean b=true;
        for(course c:University.getcrs()){
        if(c.getName().equals(jTextField1.getText())&&c.getId().equals(jTextField1.getText())){}
      // crss.remove(c);
       University.getcrs().remove(c);
       b=false;
       ...
       jTextField1.setText("");
        ...
        if(b==true){JOptionPane.showMessageDialog(null, "course not found");}
